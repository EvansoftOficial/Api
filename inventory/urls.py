...
urlpatterns=[
	url(r'^Create_Multiple/$',Create_Multiple,name="Create_Multiple"),
	...
	#COMPANY
	url(r'^Get_List_Products_Company/$',Get_List_Products_Company,name="Get_List_Products_Company"),
	url(r'^Get_Product_Company/$',Get_Product_Company,name="Get_Product_Company"),
]